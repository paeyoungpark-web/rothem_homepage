    ...
    <section className="py-24 bg-brand-100 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          ...
          <Link to="/checklist" className="inline-flex items-center justify-center px-10 py-5 text-xl font-bold rounded-2xl text-white bg-brand-500 hover:bg-brand-400 hover:-translate-y-1 transition-all shadow-[0_10px_30px_rgba(15,110,86,0.2)]">
            무료 보안 자가진단
